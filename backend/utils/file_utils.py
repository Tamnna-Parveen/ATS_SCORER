...
#simplified file hander - only basic logs
...
class ATSBaseError(Exception):
    ...
    def __int__(self,message:str,user_message:Optional[str]=None,**kwargs):
...
def get_default_location_results()-> Dict:
    return{
        ...
        'recommendation':['Location detection unavailable.'],
        'penalty_applied':0,
        '_component_status':'unavailable',
...
def get_default_id_comparison_results() -> Dict:
    return{
